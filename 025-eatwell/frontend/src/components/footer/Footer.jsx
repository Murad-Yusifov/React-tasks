...
import "./Footer.scss";
import { FaFacebook, FaFacebookF, FaHeart, FaInstagramSquare, FaTwitter } from "react-icons/fa";
  ...
  return (
    <>
      <div className="footer">
        ...
        <div className="icons">         
          <div className="div"> <FaTwitter className="icon"/></div>
          <div className="div"><FaFacebookF className="icon"/></div>
          <div className="div">
