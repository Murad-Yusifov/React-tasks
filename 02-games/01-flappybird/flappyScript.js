...
//         context.drawImage(player_img.x, player.y, player.width, player.height)
//     }
...
//     piupe_down_img = new Image()
//     pipe_down_img.src = "assets/pipe_down.png"
//     pipe_dowon_img.onload = function(){
...
//         checkCollision(player.x+ 3, player.y +_3, 52, 52, player.x, pipe_x+gap, 79, 360)
//     ){
//         game_over()
//     }
...
let board_h = 600;
let context;
// context shekil kechmek uchundur
...
let pipe_h = 360;
let pipe_x = 600;
let pipe_y = getRandomInt(30, 500);
let gap = 220;
let p_velocity = -1.2;
let pipe_scored = false
